...
def generate_launch_description():
    robot_name = DeclareLaunchArgument("robot_name", default_value="abb_irb1010")
    ...
    package_path = get_package_share_directory('abb_irb1010_gazebo')
    ...
    gz_server = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "world": PathJoinSubstitution([
                        get_package_share_directory('abb_irb1010_gazebo'),
                        'worlds',
